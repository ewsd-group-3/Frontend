...
function Form<TValues extends FieldValues>({
  ...
  formSchema: Schema<TValues>
  onSubmit?: (data: TValues, reset?: () => void) => void
}) {
  ...
  return (
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(data => (onSubmit ? onSubmit(data, () => form.reset()) : handleSubmit(data)))}>
